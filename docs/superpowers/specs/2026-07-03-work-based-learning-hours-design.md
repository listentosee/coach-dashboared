...
- `lib/integrations/game-platform/work-based-learning-hours.ts`
  - Types: `WblRow` (RPC row), `WblStudent` (`{ competitorId, name, division, odl: WblRow[], ctf: WblRow[], totalMinutes }`), `WblReport` (`{ period, coach, students, summary }`).
